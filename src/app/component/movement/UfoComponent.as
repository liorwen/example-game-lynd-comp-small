...
package app.component.movement
{
    ...
    public class UfoComponent extends MovementComponent
    {
        ...
        public function UfoComponent(lynd:Lynd, param:Object)
        {
            param.view = new Ufo();
            super(lynd, param);
        }
        ...
        override protected function moveBehavior():void
        {
            ...
            var time:Number = _dist / (MovementComponent.SPEED * 1.5);
