...
package app.component.movement
{
    ...
    public class RightMeteorComponent extends MovementComponent
    {
        public function RightMeteorComponent(lynd:Lynd, param:Object)
        {
            param.view = new RightMeteor();
            super(lynd, param);
        }
        ...
        {
            var pt1:Point = new Point(860, -60);
            var pt2:Point = new Point(-120, 888);
